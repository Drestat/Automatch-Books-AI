    ...
    <SubscriptionGuard status={subscriptionStatus} daysRemaining={daysRemaining}>
      <div className="min-h-screen text-white selection:bg-brand selection:text-white pb-20">
        ...
        <footer className="mt-24 border-t border-white/5 pt-12 text-center">
          ...
          <p className="text-white/20 text-xs">AutoMatch Books AI Engine &copy; 2026. Powered by Google Gemini 3 Flash. <span className="ml-2 px-1.5 py-0.5 rounded border border-white/5 bg-white/[0.02] text-[10px] font-bold">v3.43.0</span></p>
        </footer>
