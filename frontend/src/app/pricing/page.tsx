...
export default function PricingPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white pt-20 selection:bg-brand selection:text-white">
            <PricingJsonLd />
                        ...
                        {TIERS.map((tier, index) => (
                            ...
                            >
                                ...
                                <div className="mb-8">
                                    ...
                                    <p className="text-white/60 text-sm min-h-[40px]">{tier.description}</p>
                                </div>

                                <div className="flex items-baseline gap-1 mb-8">
                                    <span className="text-4xl font-black tracking-tight">{tier.price}</span>
                                    <span className="text-white/60 font-bold">{tier.period}</span>
                                </div>

                                <ul className="space-y-4 mb-8">
                                    {tier.features.map((feature) => (
                                        <li key={feature} className="flex items-start gap-3 text-sm">
                                            <Check size={16} className={`mt-0.5 ${tier.highlight ? 'text-brand' : 'text-white/60'
                                                }`} />
