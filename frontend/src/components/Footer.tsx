        ...
        <footer className="py-20 px-6 border-t border-white/5 bg-black">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
                <div className="col-span-1 md:col-span-2">
                    <Link href="/" className="flex items-center gap-2 mb-6 group" aria-label="AutoMatch Books AI Home">
                ...
                <div>
                    <p className="text-sm font-bold uppercase tracking-widest mb-6" role="heading" aria-level={2}>Product</p>
                    <ul className="space-y-4 text-white/60 text-sm">
                        ...
                        <li><Link href="/features" className="hover:text-brand-accent transition-colors text-brand-accent font-bold underline decoration-brand-accent/30 underline-offset-4">Feature Guide</Link></li>
                        <SignedIn>
                ...
                <div>
                    <p className="text-sm font-bold uppercase tracking-widest mb-6" role="heading" aria-level={2}>Legal & Support</p>
                    <ul className="space-y-4 text-white/60 text-sm">
            ...
            <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/50">
